...
Tundra.WebTundraModel = function() {
    ...
    this.loginData = {
        "name":369369	// useless declaration
    };
	console.log("is this called somewhere?");
}
...
Tundra.WebTundraModel.prototype = {
    ...
    connectClient: function(host, port) {
		...
		//console.log(this.client.connect(host, port, this.loginData));
    }
};
/*
...
entity, componentTypeId, targetAttributeId, condFunc, mySignal) {
	...
	console.log("when does this strange be called");
}
